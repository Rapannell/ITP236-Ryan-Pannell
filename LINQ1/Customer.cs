...
namespace LINQ1
{
    public class Customer
    {
        ...
        public double OrderTotal => SalesOrders.Sum(order => order.OrderTotal); // Calculate total order using LINQ
        public int BackOrdered => SalesOrders.Sum(order => order.Quantity - order.Shipped); // Calculate backordered quantity using LINQ
